...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            <nav class="bg-gray-800 border-b border-yellow-400 shadow-neon">
                                ...
                                >
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            <!-- Team Management -->
                                            <div
                                                class="block px-4 py-2 text-xs text-blue-300 bg-gray-800 border-b border-yellow-400"
                                            >
                                                Manage Team
                                            </div>
                                            ...
                                            <DropdownLink
                                                ...
                                                "
                                                class="text-gray-100 hover:text-yellow-400 hover:bg-gray-700"
                                            >
                                                Team Settings
                                            </DropdownLink>
                                            ...
                                            >
                                                <div
                                                    class="border-t border-yellow-400"
                                                />
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <DropdownLink
                                                            as="button"
                                                            class="w-full text-left text-gray-100 hover:text-yellow-400 hover:bg-gray-700"
                                                        >
                                                            <div
                                                                ...
                                                                <svg
                                                                    v-if="
                                                                        ...
                                                                        $page
                                                                            ...
                                                                            .current_team_id
                                                                    "
                                                                    class="me-2 h-5 w-5 text-yellow-400"
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                    fill="none"
                                                                    viewBox="0 0 24 24"
                                                                    stroke-width="1.5"
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <!-- Account Management -->
                                        <div
                                            class="block px-4 py-2 text-xs text-blue-300 bg-gray-800"
                                        >
                                            Manage Account
                                        </div>
